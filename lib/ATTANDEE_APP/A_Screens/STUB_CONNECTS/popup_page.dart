import 'dart:async';
import 'package:cleaneo_user/ATTANDEE_APP/A_Screens/STUB_CONNECTS/profileEdite_page.dart';
import 'package:cleaneo_user/ATTANDEE_APP/A_Screens/STUB_CONNECTS/stub_connected_data/stub_data.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';


import '../../../SGConnectProfile.dart';
...
class _PopUpPageState extends State<PopUpPage> {
  ...
  void initState() {
    ...
    Timer.periodic(Duration(seconds: 3), (Timer timer) {
      setState(() {
        _currentIndex = ((_currentIndex + 1) % StubData.backgroundImages.length) as int;
      });
    });
  }
